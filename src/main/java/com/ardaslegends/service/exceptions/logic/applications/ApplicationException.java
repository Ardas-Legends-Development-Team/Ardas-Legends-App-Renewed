...
public class ApplicationException extends LogicException {
    ...
    public static ApplicationException noVoteNeededToBeRemoved(String playerName) {
        return new ApplicationException(NO_VOTE_NEEDED_TO_BE_REMOVED.formatted(playerName));
    }
